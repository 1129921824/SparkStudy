package cn.sunyuqiang.spark.sparkSQL
...
object spark_sql_transform1 {
  def main(args: Array[String]): Unit = {
    val conf: SparkConf = new SparkConf().setMaster("local[*]").setAppName("spark_sql_transform1").set("spark.testing.memory", "2147480000")
